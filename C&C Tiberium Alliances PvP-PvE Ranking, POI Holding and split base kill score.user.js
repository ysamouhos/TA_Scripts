...
(function () {
    var PvpRankMod_main = function () {
        ...
        var apoiTableLabel = null;
        var poiTableLabel = null;
        var levelTabLabel = null;
   		var rowData = null;
   		var tabView = null;
        var pData = null;
  		var dataTable = null;
        ...
        function CreateMod() {
            try {
                ...
                apoiTableLabel = new qx.ui.basic.Label("Members of are holding the following POIs").set({
                    textColor: "text-value",
                    font: "font_size_13_bold"
                });
                ...
                levelTabLabel = new qx.ui.basic.Label("Player Base levels").set({
                    textColor: "text-value",
                    font: "font_size_13_bold"
                });
                levelTab.add(levelTabLabel);
        ...
        function onPlayerInfoReceived(context, data) {
            try {
                ...
                if (rowData.length == memberCount) {
                    ...
                    apoiTableLabel.setValue("Members of " + data.an + " are holding the following POIs");
                    poiTableLabel.setValue(playerName.getValue() + " sits on the these POIs");
                    levelTabLabel.setValue(playerName.getValue() + " Base Levels");
